...
public class FileClient{
    ...
    public static void main(String[] args) throws RemoteException
    {
        ...
        try
        {
            ...
            {
            File fileName = new File("F:\\msujava\\JAVA_WORK\\TCP\\TCP\\barc.txt");
            FileInputStream fis = new FileInputStream(fileName);
            byte[] b = new byte[(int) fileName.length()];

            fis.read(b, 0, b.length);
            obj.setFile(b, "F:\\msujava\\JAVA_WORK\\TCP\\storage\\barc.txt", b.length);
            ...
            {
                File fileName = new File("F:\\msujava");
                byte[] b = obj.getFile("F:\\msujava\\JAVA_WORK\\TCP\\TCP\\barc.txt");
